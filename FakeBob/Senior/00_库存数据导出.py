...
#获取路径变量
pathname = 'D:\{}_库存明细数据.xlsx'.format(localtime)
# page = '/data/mail_data/stock/{}_库存明细数据.xlsx'.format(localtime)

# 获取压缩文件变量
zipfilepath = 'D:\{}_库存明细数据.zip'.format(localtime)
...
text_msg = MIMEText("Dear all：\n \n  附件为截止{}库存明细数据,请查收!".format(localtime)) #邮件正文内容
